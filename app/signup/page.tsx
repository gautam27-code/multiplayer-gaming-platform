  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="text-center mb-8 relative z-10">
        ...
        <p className="text-cyan-300/80 mt-2">Create a new account</p>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        <Card className="bg-black/20 backdrop-blur-xl border border-cyan-400/30 rounded-3xl shadow-2xl shadow-purple-500/20">
          <CardHeader className="text-center p-8 pb-4">
            ...
            <CardDescription className="text-cyan-300/80 mt-2">Fill in your details to get started</CardDescription>
          </CardHeader>
